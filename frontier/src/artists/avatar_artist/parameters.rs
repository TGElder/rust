        ...
        AvatarArtistParams {
            ...
            body_parts: vec![
                BodyPart {
                    ...
                    drawing_name: "body",
                    texture: "resources/textures/body",
                    width: 48.0 / 512.0,
                    height: 72.0 / 512.0,
                    mask: Some(ColorMask {
                        mask: "resources/textures/body",
                ...
                BodyPart {
                    ...
                    drawing_name: "head",
                    texture: "resources/textures/head",
                    width: 36.0 / 512.0,
                    height: 36.0 / 512.0,
                    mask: Some(ColorMask {
                        mask: "resources/textures/head",
                ...
                BodyPart {
                    ...
                    texture: "resources/textures/eye",
                    width: 6.0 / 512.0,
                    height: 6.0 / 512.0,
                    mask: None,
                },
                ...
                BodyPart {
                    ...
                    texture: "resources/textures/hand",
                    width: 12.0 / 512.0,
                    height: 12.0 / 512.0,
                    mask: Some(ColorMask {
                        mask: "resources/textures/hand",
                        color_fn: |avatar| &avatar.skin_color,
                    }),
                },
                BodyPart {
