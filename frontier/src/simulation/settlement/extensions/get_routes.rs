...
use crate::traits::{BuiltBridges, ClosestTargetsForRoutes, CostOfPath, InBoundsForRoutes, Micros};
...
where
    T: BuiltBridges + ClosestTargetsForRoutes + CostOfPath + InBoundsForRoutes + Micros,
    D: TravelDuration,
{
...
mod tests {
    ...
    #[async_trait]
    impl BuiltBridges for HappyPathTx {
    ...
    #[async_trait]
    impl BuiltBridges for PanicPathfinderTx {
        async fn built_bridges(&self) -> Bridges {
            panic!("built_bridges was called!");
        }
    }
