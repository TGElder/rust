...
pub fn triangle_interpolate(p: V2<f32>, triangle: &[V3<f32>; 3]) -> Option<V3<f32>> {
    let triangle2 = [
...
mod tests {
    ...
    fn triangle_interpolate_0() {
        ...
        let expected = Some(v3(0.0, 1.0, 2.0));
        assert!(actual.almost(&expected));
    }
    ...
    fn triangle_interpolate_1() {
        ...
        let expected = Some(v3(2.0, 5.0, 0.0));
        assert!(actual.almost(&expected));
    }
    ...
    fn triangle_interpolate_2() {
        ...
        let expected = Some(v3(4.0, 3.0, 1.0));
        assert!(actual.almost(&expected));
    }
    ...
    fn triangle_interpolate_between_0_and_1() {
        ...
        let expected = Some(v3(1.0, 3.0, 1.0));
        assert!(actual.almost(&expected));
    }
    ...
    fn triangle_interpolate_between_1_and_2() {
        ...
        let expected = Some(v3(3.0, 4.0, 0.5));
        assert!(actual.almost(&expected));
    }
    ...
    fn triangle_interpolate_between_2_and_0() {
        ...
        let expected = Some(v3(2.0, 2.0, 1.5));
        assert!(actual.almost(&expected));
    }
    ...
    fn triangle_interpolate_centre() {
        ...
        let expected = Some(v3(2.0, 3.0, 1.0));
        assert!(actual.almost(&expected));
    }
