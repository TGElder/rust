...
impl TemperatureMapper {
    pub fn earthlike(y_to_latitude: Scale<f64>, z_to_elevation: Scale<f64>) -> TemperatureMapper {
        TemperatureMapper {
            y_to_latitude,
            z_to_elevation,
